<svg {{ $attributes }} id="mainLogoSvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 150">
    ...
    <g id="symbolGroup" transform="translate(-21.5, -11.5)" filter="url(#dropShadow)">
        ...
        <g id="techNodes" style="display: none;">
            <!-- Cúspides Superior Esquerda e Direita -->
            <circle cx="55" cy="30" r="4.5" fill="#ffffff" stroke="url(#gradPrimary)" stroke-width="2"></circle>
            <circle cx="105" cy="30" r="4.5" fill="#ffffff" stroke="url(#gradPrimary)" stroke-width="2"></circle>
    ...
    <g id="textGroup" transform="translate(133, -19)">
        ...
        <!-- Detalhe Decorativo na Letra (Ponto de precisão no texto) -->
        <circle id="brandDot" cx="251.60032653808594" cy="92" r="5" fill="url(#gradAccent)"></circle>

        <!-- Subtítulo / Descrição da Aplicação -->
        <text id="svgSubText" x="2" y="128" font-family="'Inter', sans-serif" font-weight="600" font-size="14" fill="url(#gradPrimary)" letter-spacing="6" style="display: block;">LABORATÓRIO DIGITAL</text>
    </g>
</svg>